...
MyErroDetails err = new MyErroDetails();
	...
	public ResponseEntity<MyErroDetails> feedbackHandler(FeedbackException fbe, WebRequest req)
	{
		MyErroDetails err = new MyErroDetails(LocalDateTime.now(), fbe.getMessage(), req.getDescription(false));
